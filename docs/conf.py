...
project = 'Unitree B1 Documentation'
...
html_title = "Unitree B1 Documentation"
...
html_context = {
    ...
    'github_repo': 'unitree_b1_docs', # Repo name
...
htmlhelp_basename = 'UnitreeB1Documentation'
